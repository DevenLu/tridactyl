...
/** dummy */
function background(target: Object, propertyKey: string, descriptor: TypedPropertyDescriptor<any>) {
    return descriptor
}
...
function defaultHintChars() {
    ...
    //         return "1234567890"
        // default:
            ...
            return "hjklgfdsatyuioreqtazxcvmn"
    // }
}
...
function* hintnames_simple(
    ...
    for (let taglen = 1; true; taglen++) {
        ...
        //     e.join(""),
        // )
        yield* "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa".split("")
    }
}
...
function* hintnames(
    ...
    //     default:
            ...
            yield* "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa".split("")
    // }
}
